    ...
    public class I18n : INotifyPropertyChanged
    {
        ...
        private static readonly Dictionary<string, Dictionary<string, string>> Translations = new()
        {
            { "zh", new Dictionary<string, string> {
                ...
                { "AboutChangelog", "• 新增：布局备份与恢复功能，支持导出/导入 .zip 备份包\n• 新增：显示器环境变动自动保存，备份当前布局不丢失\n• 新增：MSIX 应用自启动支持，完美适配微软商店版\n• 新增：关于对话框，快速查看版本和更新内容\n• 新增：单实例应用与改进的托盘通知系统\n• 修复：多处资源泄漏和稳定性问题\n• 修复：系统限制时的自启动处理逻辑\n• 优化：桌面图标管理的内存安全与资源清理" },
            ...
            { "en", new Dictionary<string, string> {
                ...
                { "AboutChangelog", "\u2022 New: Backup & Restore - Export/import your layouts as .zip packages\n\u2022 New: Auto-save on display change - Never lose your layout when monitors change\n\u2022 New: MSIX auto-start support - Perfect for Microsoft Store version\n\u2022 New: About dialog - Quick access to version info and updates\n\u2022 New: Single-instance app with improved tray notification system\n\u2022 Fixed: Multiple resource leaks and stability issues\n\u2022 Fixed: Auto-start handling when system restrictions apply\n\u2022 Improved: Memory safety and resource cleanup for desktop icon management" },
